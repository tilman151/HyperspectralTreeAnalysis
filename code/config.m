...
basicEnsembleEC100_08Config = ...
    @() BasicEnsemble({ExampleClassifier}, ...
        ...
        0.8, ...
        true);
basicEnsembleSVM100_001Config = ...
    @() BasicEnsemble({svmPolynomial1vs1Config()}, ...
        100, ...
        0.001, ...
        true, ...
        true);
...
randomForestSpatialRegConfig = @() SpatialReg(...
    ...
    'PropagationThreshold', 0.0, ...
    'VisualizeSteps', false);
basicEnsemblePolySVMSpatialRegConfig = @() SpatialReg(...
    basicEnsembleSVM100_001Config(), ...
    'R', 10, ...
    'LabelPropagation', false, ...
    'OutputRegularization', true, ...
...
CLASSIFIER = basicEnsemblePolySVMSpatialRegConfig();
